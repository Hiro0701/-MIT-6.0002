...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_furnished(self, pos):
        ...
        """
        if (math.floor(pos.get_x()), math.floor(pos.get_y())) in self.furniture_tiles:
            return True
        else:
            return False
    ...
    def get_random_position(self):
        ...
        """
        while True:
            random_position = Position(random.uniform(0, self.width), random.uniform(0, self.height))
...
#       of a 20x20 room?
# A: The difference of performance of two robots are linear.
# When the number of robots is small, the difference is slightly large.
# And it gets smaller as the number of robots gets bigger.
#
# 2) How does the performance of the two robot types compare when two of each
#       robot cleans 80% of rooms with dimensions 
#       10x30, 20x15, 25x12, and 50x6?
# A: The difference of performance of two robots are not linear.
# The difference is minimum when the ratio is close to 1.
# As the ratio gets bigger or smaller than 1, the time step of FaultyRobot grows more than StandardRobot's.
